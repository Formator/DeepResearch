...
class MultiTurnReactAgent(FnCallAgent):
    ...
    def call_server(self, msgs, max_tries=10):
        """
        Call OpenRouter API for the Tongyi DeepResearch model
        """
        ...
        for attempt in range(max_tries):
            try:
                print(f"--- Attempting to call OpenRouter service, try {attempt + 1}/{max_tries} ---")
                ...
                if content and content.strip():
                    print("--- OpenRouter service call successful, received a valid response ---")
    ...
    def _run(self, question: str, answer: str = "", **kwargs) -> Dict:
        ...
        while num_llm_calls_available > 0:
            # Check whether time limit is reached
